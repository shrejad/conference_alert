							...
							<div class="col-lg-4 address-grid">
								<div class="row address-info">
									...
									<div class="col-md-9 address-right text-left">
										...
										<p>Email :
											<a href="mailto:example@email.com"> Shreyashjadhav14@gmail.com <br> Nidhishritrivedi@gmail.com</a>
										</p>
									</div>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-6 map">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3780.3817863911045!2d73.75824831489466!3d18.646856087335593!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2b9e7aaaaaaab%3A0xeaf569250e87c658!2sD.+Y.+PATIL+INSTITUTE+OF+MASTER+OF+COMPUTER+APPLICATIONS!5e0!3m2!1sen!2sin!4v1537893303848" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
					</div>
						...
						<div class="form">
							...
							<form action="#" method="post">
								<div class="form-group">
									...
									<input class="form-control" type="text" name="feedName" placeholder="" required="">
								</div>
								<div class="form-group">
									<label>Email</label>
									<input class="form-control" type="email" name="feedEmail" placeholder="" required="">
								</div>
								<div class="form-group">
									<label>Message</label>
									<textarea id="textarea"  name="feedmessage"placeholder=""></textarea>
								</div>
								<div class="input-group1">
									<input class="form-control" type="submit" name="feedsubmit" value="Submit">
								</div>
							</form>
						</div>
					</div>
