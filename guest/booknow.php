...
<!-- Meta tag Keywords -->
<link href="css/booknow.css" rel="stylesheet" type="text/css" media="all" />
<!-- js -->
<!-- //js -->
<!-- web-fonts -->
		 ...
		 <div class="bg-agile">
			...
			<div class="login-form">	
				<form action="#" method="post">
					...
					<input type="text"  name="Address2" placeholder="Street Address Line2" required="" />
