    ...
    <div class="wrapper">
        ...
        <div id="content">
                            ...
                            <div class="dropdown-menu top-grid-scroll drop-1">
                                ...
                                <a href="#" class="dropdown-item mt-3">
                                    <div class="notif-img-agileinfo">
                                        <img src="images/clone.jpg" class="img-fluid" alt="Responsive image">                                    </div>
                                </a>
                                <a href="#" class="dropdown-item mt-3">                                   </a>
                                <a href="#" class="dropdown-item mt-3">                                </a>
                                <a href="#" class="dropdown-item mt-3">                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="#">view all notifications</a>                            </div>
                        </li>
                            ...
                            <div class="dropdown-menu drop-3">
                                <div class="profile d-flex mr-o">
                                    <div class="profile-l align-self-center">
                                        <img src="images/profile.jpg" class="img-fluid mb-3" alt="Responsive image">                                    </div>
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="login.html">Logout</a>                            </div>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <div class="copyright-w3layouts py-xl-3 py-2 mt-xl-5 mt-4 text-center">
                <p>© 2018  Confernece Alert . All Rights Reserved | Design by
                    <a href="http://w3layouts.com/"> Nidhi Trivedi & Shreyash jadhav </a>
                </p>
            </div>
            <!--// Copyright -->
        </div>
